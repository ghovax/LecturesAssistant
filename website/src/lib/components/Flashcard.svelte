...
<div class="flashcard-container" onclick={() => (isFlipped = !isFlipped)}>
  <div class="flashcard {isFlipped ? 'flipped' : ''}">
    ...
    <div class="flashcard-face front">
      <div
        class="tile-like bg-white p-4 d-flex align-items-center justify-content-center text-center h-100"
      >
    ...
    <div class="flashcard-face back">
      <div
        class="tile-like bg-white p-4 d-flex align-items-center justify-content-center text-center h-100 border-top-orange"
      >
