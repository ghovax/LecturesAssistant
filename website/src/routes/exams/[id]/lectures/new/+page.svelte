        ...
        <div class="p-4">
          ...
          <div class="mb-0">
            ...
            <div class="form-text mt-2 small opacity-75">
              Transcripts and analysis will use this language.
            </div>
          </div>
        </div>
      </div>
            ...
            <label for="file-input" class="dropzone-label-refined">
              ...
              <div class="text-center">
                <Highlighter
                  ...
                  offsetY={2}
                >
                  <span class="fw-bold h6 mb-1 d-block text-dark"
                    >Click or drag files here</span
                  >
                </Highlighter>
                <p class="text-muted mb-0 mt-2 small px-4">
                  Recordings (MP4, MP3, WAV...) and Reference Materials (PDF,
                  PPTX, DOCX)
                </p>
              </div>
            </label>
          ...
          {#if mediaFiles.length > 0 || documentFiles.length > 0}
            <div class="file-list">
              ...
              {#if mediaFiles.length > 0}
                <div class="mb-4">
                  <div
                    class="cozy-label mb-2 opacity-75"
                  ...
                  {#each mediaFiles as file, i}
                    ...
                    >
                      <div
                        class="d-flex align-items-center gap-3 overflow-hidden"
                      >
                        <GripVertical
                          size={14}
                        ...
                        <span
                          class="text-truncate small fw-bold"
                          title={file.name}>{file.name}</span
                        >
                      </div>
                      <button
                        class="btn btn-link btn-sm text-danger p-0 border-0 shadow-none ms-2"
                  ...
                  {#each documentFiles as file, i}
                    <div class="file-item reference">
                      ...
                      >
                        ...
                        <!-- Spacer to align with media grip -->
                        <FileText
                          size={16}
  ...
  <div class="mt-5 pb-5">
    {#if uploading}
      <div class="text-center">
        ...
        <p class="text-muted fw-bold small uppercase letter-spacing-05">
          {status}
        </p>
      </div>
    {:else}
      <div class="d-flex flex-column align-items-center gap-3">
        ...
        <div
          class="d-flex align-items-center text-muted gap-2 small opacity-75"
        >
          <Info size={14} />
          <span
            >Multiple files will be combined into a single learning experience.</span
          >
        </div>
      </div>
    {/if}
