...
const (
	...
	PromptSequentialDocumentInitialContext    = "study-guides/sequential-document-initial-context.md"
	PromptSequentialDocumentSectionGeneration = "study-guides/sequential-document-section-generation.md"
)
